...
import hotel.entity.BillDepartmentOrInstitution;
import hotel.entity.BillItem;
import hotel.entity.Item;
import hotel.entity.ItemOrCategory;
import hotel.enums.BillItemType;
import hotel.enums.BillType;
import hotel.enums.ItemOrCategoryType;
import hotel.faces.BillFacade;
import hotel.faces.BillItemFacade;
...
public class FunctionsEventController {
    ...
    public void fillBookedHalls() {
        ...
        m.put("bt", BillType.MedicineIssueToPerson);
    ...
    public Bill getFunctionEvent() {
        if (functionEvent == null) {
            ...
            functionEvent.setBillType(BillType.MedicineIssueToPerson);
    ...
    public void fillBillItemsForFunctionEvent() {
        ...
        for (BillItem bi : functionEvent.getReferenceBill().getBillItems()) {
            ...
            if (bi.getItemOrCategory().getType() == ItemOrCategoryType.Investigation) {
                System.out.println("bi = " + bi);
            ...
            } else if (bi.getItemOrCategory().getType() == ItemOrCategoryType.Plan) {
                BillItem nbi = new BillItem();
...
//        functionEvent.setRetired(false);
    ...
    public void prepareAdd() {
        functionEvent = new Bill();
//        selected.setBillType(BillType.Admission);
    }

    public void prepareAddNewEvent() {
        functionEvent = new Bill();
        functionEvent.setBillType(BillType.Admission);
    }
