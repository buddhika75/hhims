...
import hotel.entity.Institution;
import hotel.controllers.util.JsfUtil;
import hotel.controllers.util.JsfUtil.PersistAction;
import hotel.faces.InstitutionFacade;
...
public class InstitutionController implements Serializable {
    ...
    @EJB
    private hotel.faces.InstitutionFacade ejbFacade;
