 ...
 */
@Entity
public class BillDepartmentOrInstitution implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof BillDepartmentOrInstitution)) {
            return false;
        }
        BillDepartmentOrInstitution other = (BillDepartmentOrInstitution) object;
    ...
    public String toString() {
        return "hotel.entity.BillDepartmentOrInstitutions[ id=" + id + " ]";
    }
